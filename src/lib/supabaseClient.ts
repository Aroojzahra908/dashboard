...
export async function deleteWhere(table: string, where: Record<string, string | number>) {
  if (!SUPABASE_URL) throw new Error("Missing SUPABASE_URL");
...
export default { fetchTable, insertInto, uploadToStorage, getPublicUrl, deleteFrom, deleteWhere, updateRow };
